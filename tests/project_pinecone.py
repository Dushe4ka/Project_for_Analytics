...
import os
import pinecone  # Убедитесь, что библиотека pinecone установлена
...
vector_store = Pinecone(index_name="your_index_name", embedding_function=embed_model)  # Укажите имя вашего индекса Pinecone
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Автоматическая загрузка данных из Pinecone при запуске
        self.load_initial_data()

    def load_initial_data(self):
        # Здесь можно реализовать логику загрузки данных из Pinecone, если это необходимо
        # Например, можно получить все данные и добавить их в векторное хранилище
        pass
    ...
    def ask_question(self):
        ...
        try:
            ...
            # Используем Pinecone для поиска
